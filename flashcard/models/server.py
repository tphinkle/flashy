...
def create_new_flashcard(user_id, front, back, labels, current_datetime):
    ...
    db_functions.insert_user_flashcard_relation(user_id, flashcard_id, labels, flashcard_functions.base_decay_time, current_datetime)
...
def register_user_flashcard_action(user_id, flashcard_id, action, current_datetime):
    ...
    last_decay_time = user_flashcard_relations['decay_time']
